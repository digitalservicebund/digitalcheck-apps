...
function handleBrowserRequest(
  ...
  responseHeaders.set(
    ...
    `default-src 'none'; script-src 'self' https: 'nonce-${nonce}'; style-src 'self'; font-src 'self'; img-src 'self'; frame-ancestors 'self'; frame-src 'self' https://calendar.google.com; connect-src 'self' https://plausible.io`,
  );
